...
BOOL EXPORTED CALLBACK IntrDlg(HWND hDlg,UINT message,WPARAM wParam,LPARAM lParam )
{
    ...
    case WM_INITDIALOG:
        ...
        ;
        i = LoadTabs(IDUS_32,szStr0);
        SendDlgItemMessage(hDlg,ID_LISTBOX1,LB_SETTABSTOPS,i,(LPARAM)(LPVOID)szStr0);
        SendDlgItemMessage(hDlg,ID_LISTBOX1,XLB_SETEXTSTYLE,XLBES_RBUTTONTRACK,
                           (LPARAM)(LPVOID)hFontAlt);
        SendDlgItemMessage(hDlg,ID_LISTRMINT,LB_SETTABSTOPS,i,(LPARAM)(LPVOID)szStr0);
        SendDlgItemMessage(hDlg,ID_LISTRMINT,XLB_SETEXTSTYLE,XLBES_RBUTTONTRACK,
                           (LPARAM)(LPVOID)hFontAlt);
        SendDlgItemMessage(hDlg,ID_LISTEXC, LB_SETTABSTOPS,i,(LPARAM)(LPVOID)szStr0);
        SendDlgItemMessage(hDlg,ID_LISTEXC,XLB_SETEXTSTYLE,XLBES_RBUTTONTRACK,
                           (LPARAM)(LPVOID)hFontAlt);
        ;
        SendDlgItemMessage(hDlg,ID_STATINTR,ST_SETTABSTOPS,LoadTabs(IDUS_33,szStr0),(LPARAM)(LPVOID)szStr0);

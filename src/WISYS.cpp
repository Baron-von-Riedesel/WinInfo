...
{
    static int BtnTab[] = {ID_SYSVIEW, ID_SYSTSS, ID_SYSLDT, 0};
    int x;
    WORD k;
    char str[80];
    char szStr1[40];
    ...
    case WM_COMMAND:
        ...
        case ID_SYSLDT:
            ...
            else if (IsLDT(HIWORD(dwParm)))
                CreateDialogParam(hInst,MAKEINTRESOURCE(IDD_LDT),hDlg,LDTDlg,dwParm);
            else if (IsReadableSelector(LOWORD(dwParm))) {
                hdp.dwOffset = 0;
        ...
        case ID_REFRESH:
            ...
            wsprintf(str,"GDTR\t%lX.%X\tLDTR\t%X\tTR\t%X\tCR0\t%lX\t",
                     GetGDTAddress(),
                     GetGDTLimit(),
                     GetLDTR(),
                     GetTR(),
    ...
    case WM_CLOSE:
        ...
        break;
    case WM_INITDIALOG:
        SendDlgItemMessage(hDlg,ID_LISTBOX1,LB_SETTABSTOPS,LoadTabs(IDUS_30,str),(LPARAM)(LPVOID)str);
        SendDlgItemMessage(hDlg,
                           ID_LISTBOX1,
                           XLB_SETEXTSTYLE,
                           XLBES_RBUTTONTRACK,
                           (LPARAM)(LPVOID)hFontAlt);
        SendDlgItemMessage(hDlg,ID_STATUS1,ST_SETTABSTOPS,LoadTabs(IDUS_31,str),(LPARAM)(LPVOID)str);

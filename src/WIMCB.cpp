...
BOOL EXPORTED CALLBACK MCBDlg(HWND hDlg,UINT message,WPARAM wParam,LPARAM lParam )
{
...
#ifdef _TRACE_
                wsprintf(szStr,"MCBDlg.ID_SUBDLG1: hdp.dwOffset=%lX\r\n",hdp.dwOffset);
    ...
    case WM_INITDIALOG:
        ;
        SendDlgItemMessage(hDlg,ID_LISTBOX1,LB_SETTABSTOPS,LoadTabs(IDUS_19,szStr),(LPARAM)(LPVOID)szStr);
        ...
        ;
        SendDlgItemMessage(hDlg,ID_STATUS1,ST_SETTABSTOPS,LoadTabs(IDUS_23,szStr),(LPARAM)(LPVOID)szStr);
